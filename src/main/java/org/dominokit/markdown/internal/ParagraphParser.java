 ...
 * track of any definition-like prefixes, and only turns the remaining paragraph content into
 * inline children at the end.
 */
public class ParagraphParser extends AbstractBlockParser {
  ...
  private final LinkReferenceDefinitionParser linkReferenceDefinitionParser =
    ...
    /**
     * Record source spans for the portion of the line that belongs to the paragraph or any
     * embedded reference definitions.
     */
    @Override
    ...
    /**
     * Finalize the paragraph by inserting extracted definitions before it and dropping the block
     * when no paragraph content remains.
     */
    @Override
