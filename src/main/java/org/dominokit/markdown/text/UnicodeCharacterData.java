...
/** Generated from JDK Character APIs for GWT-safe Unicode classification. */
final class UnicodeCharacterData {
  ...
  private static final int[] LETTER_RANGES = {
    ...
    0x860, 0x86A, 0x8A0, 0x8B4, 0x8B6, 0x8C7, 0x904, 0x939,
    ...
    0xC2A, 0xC39, 0xC3D, 0xC3D, 0xC58, 0xC5A, 0xC60, 0xC61,
    ...
    0xA6A0, 0xA6E5, 0xA717, 0xA71F, 0xA722, 0xA788, 0xA78B, 0xA7BF,
    ...
    0x10F00, 0x10F1C, 0x10F27, 0x10F27, 0x10F30, 0x10F45, 0x10FB0, 0x10FC4,
    ...
    0x11680, 0x116AA, 0x116B8, 0x116B8, 0x11700, 0x1171A, 0x11800, 0x1182B,
    ...
    0x11FB0, 0x11FB0, 0x12000, 0x12399, 0x12480, 0x12543, 0x13000, 0x1342E,
  ...
  private static final int[] PUNCTUATION_AND_SYMBOL_RANGES = {
  ...
  private static final int[] SPACE_SEPARATOR_RANGES = {
    0x20, 0x20, 0xA0, 0xA0, 0x1680, 0x1680, 0x2000, 0x200A, 0x202F, 0x202F, 0x205F, 0x205F, 0x3000,
    0x3000
  };
  ...
  static boolean isLetter(int codePoint) {
    return inRanges(LETTER_RANGES, codePoint);
  }

  static boolean isPunctuationOrSymbol(int codePoint) {
    return inRanges(PUNCTUATION_AND_SYMBOL_RANGES, codePoint);
  }

  static boolean isSpaceSeparator(int codePoint) {
